...
![Terraform Initialization](./screenshots/01-terraform-init-success.png)
![Infrastructure Provisioning](./screenshots/02-terraform-infrastructure-deployment.png)
![DynamoDB Schema](./screenshots/03-dynamodb-table-design.png)
![Lambda Overview](./screenshots/04-lambda-function-overview.png)
![Lambda Logic](./screenshots/05-lambda-function-code.png)
![API Gateway Endpoint](./screenshots/06-api-gateway-endpoint.png)
![Lambda Integration Response](./screenshots/07-api-gateway-lambda-response.png)
![CORS Configuration](./screenshots/08-api-gateway-cors-config.png)
![S3 Access Control (Private)](./screenshots/09-s3-private-access-control.png)
![Frontend Deployment](./screenshots/10-s3-frontend-deployment.png)
![CloudFront Distribution](./screenshots/11-cloudfront-distribution.png)
![Live CDN Deployment](./screenshots/12-cloudfront-distribution-live.png)
![Local Dev Environment](./screenshots/13-local-development-environment.png)
![DNS Delegation (Namecheap → Route 53)](./screenshots/14-domain-nameserver-delegation.png)
![Route 53 DNS Configuration](./screenshots/15-route53-dns-records.png)
![DNS Resolution Validation](./screenshots/16-dns-resolution-verification.png)
![Production Domain (Live App)](./screenshots/17-live-application-production-domain.png)
![CI/CD Pipeline Execution](./screenshots/18-github-actions-cicd-success.png)